...
def set_requires_grad_last_layers(model: nn.Module, layer_prefixes: list[str]):
    """
    Enable gradients ONLY for parameters whose names start with one of layer_prefixes.
